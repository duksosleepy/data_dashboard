    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.p(
                    "Thống kê thành công và thất bại trong 3 tháng gần nhất",
                    class_name="text-sm text-gray-500",
                ),
            ),
            rx.el.div(
                time_range_button("3 tháng gần nhất"),
                time_range_button("30 ngày gần nhất"),
                time_range_button("7 ngày gần nhất"),
